"use strict";
let selectMountainEl = document.getElementById("select-mountain");
let mountainsContainer = document.getElementById("mountains-container");

window.onload = function (){
    populateMountainDropdown();

    selectMountainEl.onchange = function () {
        let selectedMountain = selectMountainEl.value;
...
const mountainsArray = [
    ...
    // dropdown for each mountain
    function populateMountainDropdown() {
        // Added default
        let defaultOption = document.createElement("option");
        defaultOption.text = "Choose a Mountain";
        defaultOption.value = "";
        selectMountainEl.add(defaultOption);
    ...
    function displayMountains(selectedMountain) {
        ...
        if (mountain) {
            ...
            messageEl.textContent = "Mountain not found";
            mountainsContainer.appendChild(messageEl);
        }
    };
